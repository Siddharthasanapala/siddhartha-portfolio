...
import { Badge, Container, Reveal, Section, StaggerGroup, StaggerItem } from "@/components/ui";
  ...
  return (
    <Section id="timeline">
      <Container className="flex flex-col gap-10">
        ...
        <StaggerGroup as="ol" className="flex flex-col gap-8 border-l border-border pl-6">
          {timeline.map((entry) => (
            <StaggerItem as="li" key={entry.id} className="relative">
